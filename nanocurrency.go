...
//NanoRPC contains the connection details for the Nano node.
type NanoRPC struct {
	Host string
	Port string
}
...
func BlockCount(rpc NanoRPC) (map[string]interface{}, error) {
...
func AccountBalance(rpc NanoRPC, account string) (map[string]interface{}, error) {
...
func AccountBlocks(rpc NanoRPC, account string) (map[string]interface{}, error) {
...
func AccountInformation(rpc NanoRPC, account string, optional map[string]string) (map[string]interface{}, error) {
...
func AccountCreate(rpc NanoRPC, wallet string, optional map[string]string) (map[string]interface{}, error) {
...
func AccountGet(rpc NanoRPC, key string) (map[string]interface{}, error) {
...
func AccountHistory(rpc NanoRPC, account string, count string, optional map[string]string) ([]byte, error) {
...
func Pending(rpc NanoRPC, account string, optional map[string]string) ([]byte, error) {
...
func BlockConfirm(rpc NanoRPC, hash string) (string, error) {
...
func BlockInfo(rpc NanoRPC, hash string) ([]byte, error) {
